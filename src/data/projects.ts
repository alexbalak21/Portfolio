...
export const projects = [
  {
    ...
    description: "Full-stack e-commerce platform featuring real-time inventory synchronization, secure payment processing, personalized product recommendations, and an optimized checkout flow.",
