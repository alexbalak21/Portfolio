          ...
          {services.slice(0, 2).map((service, index) => {
            ...
            return (
              <FadeIn key={service.id} delay={100 + index * 100}>
                <div className="group relative bg-white/5 border border-white/10 rounded-3xl p-8 hover:border-primary/30 transition-colors duration-300 h-full min-h-70 flex flex-col">
                  <div className="mb-6">
