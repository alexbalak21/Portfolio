                ...
                {Object.entries(SOCIAL_LINKS).map(([platform, url]) => {
                  ...
                  return Icon ? (
                    <a
                      ...
                      className="group relative p-4 bg-white/5 rounded-xl border border-white/10 hover:bg-white/10 hover:scale-110 transition-all duration-300"
                    >
                      <Icon className="w-5 h-5 text-white/60 hover:text-primary transition-colors duration-300" />
                      <div className="absolute inset-0 bg-linear-to-br from-primary/0 to-primary/0 group-hover:from-primary/10 group-hover:to-primary/5 rounded-xl duration-300 pointer-events-none" />
                    </a>
                  ) : null;
                })}
              </div>
